...
struct AddCoffeeView: View {
    ...
    private func placeOrder(_ order: OrderElement) async {
    ...
    private func updateOrder(_ order: OrderElement) async {
        do {
    ...
    private func saveOrUpdate() async {
        ...
        if let order {
            ...
            let order = OrderElement(name: name, coffeeName: coffeeName, total: Double(price) ?? 0.0, size: coffeeSize)
